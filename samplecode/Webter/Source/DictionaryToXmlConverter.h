...
public:
	...
	*/
	DictionaryToXmlConverter(Dictionary dictionary);
...
{
public:
	DocDictionaryToXmlConverter(Dictionary dict, std::string dictName);
...
{
public:
	ArtDictionaryToXmlConverter(Dictionary dict, std::string artName);
