//========================================================================================
//  
//  $File: //ai_stream/rel_21_0/devtech/sdk/public/samplecode/CodeSnippets/SnpGraphicStyle.cpp $
//
//  $Revision: #1 $
//
			...
			if(sAIArtStyleParser->ContainsPaint(parser)){
				...
				for(ai::int32 n = 0; n < numPaintFields ;n++){
					...
					if(sAIArtStyleParser->IsFill(parserPaintField)){
						...
						sAIArtStyleParser->GetPaintLiveEffectInfo(parserPaintField, &liveEffect, nil);
						if (liveEffect){
