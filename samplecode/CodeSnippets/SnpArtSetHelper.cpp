//========================================================================================
//  
//  $File: //ai_stream/rel_21_0/devtech/sdk/public/samplecode/CodeSnippets/SnpArtSetHelper.cpp $
//
//  $Revision: #1 $
//
...
/* index operator
*/
AIArtHandle SnpArtSetHelper::operator [] (size_t index) const
{
...
/*
*/
size_t SnpArtSetHelper::GetCount() const
{
	size_t result = 0;
