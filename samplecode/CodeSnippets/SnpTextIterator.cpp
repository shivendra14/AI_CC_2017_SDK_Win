//========================================================================================
//  
//  $File: //ai_stream/rel_21_0/devtech/sdk/public/samplecode/CodeSnippets/SnpTextIterator.cpp $
//
//  $Revision: #1 $
//
				...
				for (ASInt32 charIndex = 0; charIndex < story.GetSize(); charIndex++) {
					...
					switch (kernType) {
						...
						case kOpticalKern:
							...
							break;
                        case kMetricRomanOnlyKern:
                            log->WritePrintf("%d. %s", charIndex, "kMetricRomanOnlyKern");
							break;
					}
				}
			}
