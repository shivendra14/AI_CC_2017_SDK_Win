//========================================================================================
//
//  $File: //ai_stream/rel_21_0/devtech/sdk/public/samplecode/TextFileFormat/Source/TextFileFormatPlugin.cpp $
//
//  $Revision: #1 $
//
...
ASErr TextFileFormatPlugin::AddFileFormats(SPInterfaceMessage* message) 
{
	...
	this->CStrToPStr(pstrSelected, kMaxStringLength);
	this->CStrToPStr(pstrAll, kMaxStringLength);
	affd.title = (unsigned char*)pstrSelected;
	affd.titleOrder = 0;
	affd.extension = "txt";
