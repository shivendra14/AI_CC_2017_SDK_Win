//========================================================================================
//  
//  $File: //ai_stream/rel_21_0/devtech/sdk/public/samplecode/MarkedObjects/Source/MarkedObjectsPlugin.cpp $
//
//  $Revision: #1 $
//
...
ASErr MarkedObjectsPlugin::StartupPlugin( SPInterfaceMessage *message )
{
	...
	toolData.darkIconResID = kMarkedObjectsToolDarkIconResID;
...
ASErr MarkedObjectsPlugin::TrackToolCursor( AIToolMessage* message )
{
	AIErr error = kNoErr;
	if(sAIUser != NULL)
		error = sAIUser->SetCursor(kMarkedObjectsToolIconResID, fResourceManagerHandle);
	return error;
}
