//========================================================================================
//  
//  $File: //ai/mainline/devtech/sdk/public/samplecode/Tutorial/Resources/Tutorial.r $
//
//  $Revision: #6 $
//
 ...
 * PluginName.r -> eg. Tutorial.r - for standard image definitions
 * PluginName2x.r -> eg. Tutorial2x.r - for HiDPI image definitions
 *
 *
